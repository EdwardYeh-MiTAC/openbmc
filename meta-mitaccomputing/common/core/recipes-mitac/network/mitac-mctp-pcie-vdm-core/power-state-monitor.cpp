...
void Ast2600PEHRC4HostStateSubject::pollingTask() {
    ...
    boost::asio::steady_timer postCompleteDelayTimer(*_io_ctx);
        ...
        if (current_reading != previous_reading) {
            ...
            if (PERST == 0) {
                ...
                if ((BusNum == 0) && (DevNum ==0)) {
                    ...
                    lg2::info("Ast2600PEHRC4HostStateSubject::pollingTask BDF assigned by HOST.");
                    postCompleteDelayTimer.expires_after(std::chrono::seconds(180));
                    postCompleteDelayTimer.async_wait([&](const boost::system::error_code& error) {
