...
class NVMEMiDriverIntf: public MCTPDriverIntf
{
    public:
        NVMEMiDriverIntf();
        ~NVMEMiDriverIntf() = default;
...
class NVMEMIDriverHandle: public MCTPDriverHandle
{
    public:
        NVMEMIDriverHandle(const MCTPDriverIntf* drvIntf, const MCTPEndPointBase* mctpEp);
        ~NVMEMIDriverHandle();
        bool runTask();
