...
SRC_URI = "https://github.com/AspeedTech-BMC/riscv-gnu-toolchain/releases/download/v${PV}/${BPN}.tar.gz;subdir=${BPN}"
...
do_install() {
    ...
    cp --no-preserve=ownership -rf ${UNPACKDIR}/${BPN} ${D}${datadir}/
}
